		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsticketbooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsticketbooking-display": {
								"semanticObject": "nsticketbooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.ticketbooking",
									"url": sap.ui.require.toUrl("ns/ticketbooking")
								}
							}
						}
					}
